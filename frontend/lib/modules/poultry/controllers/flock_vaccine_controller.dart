...
import '../services/flock_vaccine_service.dart';

class FlockVaccineController extends ChangeNotifier {
  FlockVaccineController() : _service = FlockVaccineService() {
    OfflineSyncService.instance.addSyncListener(_onSyncComplete);
    OfflineSyncService.instance
        .addTempIdListener('flock-vaccines', _onTempIdReplaced);
  }

  final FlockVaccineService _service;

  List<FlockVaccineModel> _items = [];
  String? _currentFlockId;
  bool _isLoading = false;
  String? _error;

  List<FlockVaccineModel> get items => _items;
  ...
  void dispose() {
    ...
    OfflineSyncService.instance
        .removeTempIdListener('flock-vaccines', _onTempIdReplaced);
    super.dispose();
  }
  ...
  void _onSyncComplete() {
    ...
    final cacheKey = OfflineCacheService.poultryListKey('flock-vaccines',
        queryString: qs);
