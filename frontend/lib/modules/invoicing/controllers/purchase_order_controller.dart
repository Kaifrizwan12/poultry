...
class PurchaseOrderController extends ChangeNotifier {
  PurchaseOrderController() : _service = PurchaseOrderService() {
    OfflineSyncService.instance.addSyncListener(_onSyncComplete);
    OfflineSyncService.instance.addTempIdListener('purchase-orders', _onTempIdReplaced);
  }
  ...
  Future<PurchaseOrderModel> add(Map<String, dynamic> payload) async {
  ...
  void _onSyncComplete() {
    final cached = OfflineCacheService.readList(
        OfflineCacheService.invoicingListKey('purchase-orders'));
