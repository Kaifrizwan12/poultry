...
class RecoveryInvoiceWiseModel extends BaseSettingsModel {
  RecoveryInvoiceWiseModel({required String id, required Map<String, dynamic> data})
      : super(id: id, data: data);

  factory RecoveryInvoiceWiseModel.fromMap(Map<String, dynamic> map) {
    final d = Map<String, dynamic>.from(map)..remove('id');
    return RecoveryInvoiceWiseModel(id: '${map['id'] ?? ''}', data: d);
  }
